-- KickStore - Installation complète de la base de données
-- Exécuter ce fichier dans phpMyAdmin pour créer toute la base de données

-- Créer la base de données
CREATE DATABASE IF NOT EXISTS kickstore CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE kickstore;
...
-- Message de succès
SELECT 'Base de données KickStore créée avec succès!' AS message;
